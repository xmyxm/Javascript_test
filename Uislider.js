define(['UIView', getAppUITemplatePath('ui.slider'), 'UIScroll'], function (UIView, template, UIScroll) {
  ...
  return _.inherit(UIView, {
    ...
    _resetLoop: function () {
      if (!this.needLoop || this.datamodel.data.length === 0){
        return;
      }
    ...
    setIndex: function (i, noPosition, noEvent, time) {
      if (typeof noPosition == 'undefined' && i == this.datamodel.index){
        noPosition = true;
      }
      ...
      if (!noPosition){
        this.adjustPosition(true, time);
      }
      this.resetCss();
      if (noEvent !== true && isChange) {
        if(this.changedAction){
          this.changedAction.call(this, this.getSelected());
        }
        if(this.changed){
              this.changed.call(this, this.getSelected());
        }
      }      
    },
